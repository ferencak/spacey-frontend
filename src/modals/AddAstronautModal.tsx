      ...
      <ModalWrapper>
        ...
        <ModalContent>
          <div className="flex flex-col space-y-4">
            ...
            <div className="flex justify-end items-center pt-4 space-x-3 rounded-b border-t border-gray-200">
              <Button
                text="Create"
                ...
                disabled={
                  !astronautData.firstName ||
                  !astronautData.lastName ||
                  !astronautData.birthDate ||
                  !astronautData.superPower
                }
                onClick={onSubmit}
              />
            </div>
